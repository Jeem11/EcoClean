document.addEventListener('DOMContentLoaded', function () {
    function fetchData() {
        ...
        xhttp.open('GET', 'fetch_rqbusiness.php', true);
        xhttp.onreadystatechange = function () {
            if (this.readyState === 4 && this.status === 200) {
                document.querySelector('#rqbusiness_container tbody').innerHTML = this.responseText;
    ...
    fetchData(); // Initial fetch of business data
});
