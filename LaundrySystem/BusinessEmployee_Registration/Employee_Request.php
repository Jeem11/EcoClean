...
try {
    ...
    $Employee = str_replace(' ', '', $EmployeeName);
    $bday = $_POST['EBday'];
    ...
    if (isset($_FILES['Employee_File']) && $_FILES['Employee_File']['error'] === UPLOAD_ERR_OK) {
        ...
        $pic_name = $Employee . "_pic." . $fileExtension;
    ...
    if (isset($_FILES['SSS_File']) && $_FILES['SSS_File']['error'] === UPLOAD_ERR_OK) {
        ...
        $fileExtension = pathinfo($original_name, PATHINFO_EXTENSION);
        $SSS_name = $Employee . "_SSS." . $fileExtension;
    ...
    if (isset($_FILES['E_Sign']) && $_FILES['E_Sign']['error'] === UPLOAD_ERR_OK) {
        ...
        $fileExtension = pathinfo($original_name, PATHINFO_EXTENSION);
        $Sign_name = $Employee . "_Sign." . $fileExtension;
        ...
        $stmtAgreement->bind_param("issssi", $rqemppic_ID, $EmployeeName, $Sign_name, $mime, $size, $data);
