    ...
    <div class="container">
        ...
        <div class="plans">
            <div class="plan basic">
                ...
                <button type="button" class="subscribe-button" name="basic" value="basic">Subscribe</button>
                <ul class="features">
            ...
            <div class="plan standard">
                ...
                <button type="button" class="subscribe-button" name="standard" value="standard">Subscribe</button>
                <ul class="features">
            ...
            <div class="plan premium">
                ...
                <button type="button" class="subscribe-button" name="premium" value="premium">Subscribe</button>
                <ul class="features">
            ...
            <div class="plan vip">
                ...
                <button type="button" class="subscribe-button" name="vip" value="vip">Subscribe</button>
                <ul class="features">
